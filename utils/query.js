...
*/
const Query = async (mysql, arguments) => {
...
const Insert = async (tabella, rows) => {
    if (!tabella || !rows) {
...
*/
const Update = async (tabella, columns, whereCondition, arguments) => {
...
* @params {object} argumentsWhere nome_segnaposto: valore
*/
const Delete = async (tabella, whereCondition, arguments) => {
...
module.exports = { Query, Insert, Update, Delete };